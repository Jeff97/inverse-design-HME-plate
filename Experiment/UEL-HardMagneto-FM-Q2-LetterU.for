...
!     swap (x,y) in Mathematica ArcTan[x,y] to align with FORTRAN ATan2(y,x)
      Theta_M = Pi + ASIN((64.0*h**2 * Pi**2 *SIN((Pi*GaussXc)/70.0)**2
     &  * SIN((Pi*GaussXc)/35.0)) / (105.0 * SQRT(Epsilon**2 * (210.0 + 
     &  3.0*h*Pi - 4.0*h*Pi*COS((Pi*GaussXc)/35.0) + h*Pi*
     &  COS((2.0*Pi*GaussXc)/35.0))**2))) - ATAN2(-Epsilon * (210.0 +
     &  3.0*h*Pi - 4.0*h*Pi*COS((Pi*GaussXc)/35.0) + h*Pi*
     &  COS((2.0*Pi*GaussXc)/35.0)) * SIN((Pi*GaussXc)/70.0 - Theta_b -
     &  (2.0/3.0)*SIN((Pi*GaussXc)/35.0) + (1.0/12.0)*
     &  SIN((2.0*Pi*GaussXc)/35.0)), -Epsilon * (210.0 + 3.0*h*Pi - 
     &  4.0*h*Pi*COS((Pi*GaussXc)/35.0) + h*Pi*COS((2.0*Pi*GaussXc)/
     &  35.0)) * COS((Pi*GaussXc)/70.0 - Theta_b - (2.0/3.0)*
     &  SIN((Pi*GaussXc)/35.0) +(1.0/12.0)*SIN((2.0*Pi*GaussXc)/35.0)))
