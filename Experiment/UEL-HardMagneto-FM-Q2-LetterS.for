...
!     swap (x,y) in Mathematica ArcTan[x,y] to align with FORTRAN ATan2(y,x)
      Theta_M = Pi + ASIN((88.0*h**2 * Pi * (Pi*(140.0 + 3.0*GaussXc) *
     &  COS((Pi*GaussXc)/35.0) + 210.0*SIN((Pi*GaussXc)/35.0))) / 
     &  (105.0 * SQRT((35.0*Epsilon*(33.0*h + 700.0*Pi - 33.0*h*
     &  COS((Pi*GaussXc)/35.0)) + 11.0*h*Pi*(140.0 + 3.0*GaussXc)*
     &  Epsilon*SIN((Pi*GaussXc)/35.0))**2))) -
     &  ATAN2(Epsilon * (35.0*(33.0*h + 700.0*Pi - 33.0*h*
     &  COS((Pi*GaussXc)/35.0)) + 11.0*h*Pi*(140.0 + 3.0*GaussXc)*
     &  SIN((Pi*GaussXc)/35.0)) * SIN(Theta_b - (11.0*
     &  (140.0 + 3.0*GaussXc)*SIN((Pi*GaussXc)/70.0)**2) /
     &  (350.0*Pi)),
     &  -Epsilon * COS(Theta_b - (11.0*(140.0 + 3.0*GaussXc)*
     &  SIN((Pi*GaussXc)/70.0)**2)/(350.0*Pi)) * (35.0*(33.0*h + 
     &  700.0*Pi - 33.0*h*COS((Pi*GaussXc)/35.0)) + 11.0*h*Pi*
     &  (140.0 + 3.0*GaussXc)*SIN((Pi*GaussXc)/35.0)))
