...
!     swap (x,y) in Mathematica ArcTan[x,y] to align with FORTRAN ATan2(y,x)
      Theta_M = Pi + ASIN((16.0*h**2 * Pi**2 * 
     &  SIN((2.0*Pi*GaussXc)/35.0)) / 
     &  (105.0 * SQRT(Epsilon**2 * (70.0 + h*Pi - 
     &  h*Pi*COS((2.0*Pi*GaussXc)/35.0))**2))) - 
     &  ATAN2(Epsilon * (-70.0 - h*Pi + h*Pi*COS((2.0*Pi*GaussXc)/
     &  35.0)) * SIN((Pi*GaussXc)/70.0 - Theta_b - 
     &  0.25*SIN((2.0*Pi*GaussXc)/35.0)), 
     &  Epsilon * (-70.0 - h*Pi + h*Pi*COS((2.0*Pi*GaussXc)/
     &  35.0)) * COS((Pi*GaussXc)/70.0 - Theta_b - 
     &  0.25*SIN((2.0*Pi*GaussXc)/35.0)))
