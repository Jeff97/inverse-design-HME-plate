...
C     PROPS(5) - Aj: shape parameter 1
...
C     PROPS(9) - nj: shape parameter 2
...
!     swap (x,y) in Mathematica ArcTan[x,y] to align with FORTRAN ATan2(y,x)
      Theta_M = Pi - ASIN((8.0 * h**2 * nj**2 * Pi**2 * Aj * SIN(nj *
     & Pi * GaussXc)) / (3.0 * SQRT((Epsilon + h * nj * Pi * Epsilon *
     & Aj * COS(nj * Pi * GaussXc))**2))) - ATAN2(Epsilon * (1.0 +
     & h * nj * Pi * Aj * COS(nj * Pi * GaussXc)) * SIN(Theta_b - Aj *
     & SIN(nj * Pi * GaussXc)), -Epsilon * (1.0 + h * nj * Pi * Aj *
     & COS(nj * Pi * GaussXc)) * COS(Theta_b - Aj * SIN(nj * Pi *
     & GaussXc)))
