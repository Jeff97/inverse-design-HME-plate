...
!     swap (x,y) in Mathematica ArcTan[x,y] to align with FORTRAN ATan2(y,x)
      ! g0 = Finalg * Cur_time ! g0 is the bending angle that goes from 0 to prescribed value
      g0 = Finalg
      Theta_M = ASIN((48.0 * g0 * Pi**2 * 
     &  SIN((3.0 * Pi * GaussXc) / 2.0)) /
     &  (5.0 * SQRT((100.0 + 3.0 * g0 * Pi * 
     &  COS((3.0 * Pi * GaussXc) / 2.0))**2))) -
     &  ATAN2((100.0 + 3.0 * g0 * Pi * 
     &  COS((3.0 * Pi * GaussXc) / 2.0)) * 
     &  COS(g0 * SIN((3.0 * Pi * GaussXc) / 2.0)),
     &  -((100.0 + 3.0 * g0 * Pi * 
     &  COS((3.0 * Pi * GaussXc) / 2.0)) * 
     &  SIN(g0 * SIN((3.0 * Pi * GaussXc) / 2.0))))
