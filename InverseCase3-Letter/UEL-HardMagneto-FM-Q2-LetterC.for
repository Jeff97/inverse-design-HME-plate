...
!     swap (x,y) in Mathematica ArcTan[x,y] to align with FORTRAN ATan2(y,x)
      Theta_M = Pi + ASIN((128.0 * Pi**2 * SIN(4.0 * Pi * GaussXc)) /
     &  (45.0 * (50.0 + Pi - Pi * COS(4.0 * Pi * GaussXc)))) -
     &  ATAN2(COS(Pi * GaussXc - 0.25 * SIN(4.0 * Pi * GaussXc)),
     &  -SIN(Pi * GaussXc - 0.25 * SIN(4.0 * Pi * GaussXc)))
