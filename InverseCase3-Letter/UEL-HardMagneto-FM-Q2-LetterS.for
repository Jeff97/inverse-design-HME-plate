...
!     swap (x,y) in Mathematica ArcTan[x,y] to align with FORTRAN ATan2(y,x)
      Theta_M = Pi + ASIN((1408.0 * Pi * (Pi * (2.0 + 3.0 * GaussXc) *
     &  COS(2.0 * Pi * GaussXc) + 3.0 * SIN(2.0 * Pi * GaussXc))) /
     &  (45.0 * (33.0 + 500.0 * Pi - 33.0 * COS(2.0 * Pi * GaussXc) +
     &  22.0 * Pi * (2.0 + 3.0 * GaussXc) * SIN(2.0 * Pi * GaussXc)))) -
     &  ATAN2(COS((11.0 * (2.0 + 3.0 * GaussXc) * 
     &  SIN(Pi * GaussXc)**2) / (5.0 * Pi)), 
     &  -SIN((11.0 * (2.0 + 3.0 * GaussXc) * 
     &  SIN(Pi * GaussXc)**2) / (5.0 * Pi)))
