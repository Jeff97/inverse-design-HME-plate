...
!     swap (x,y) in Mathematica ArcTan[x,y] to align with FORTRAN ATan2(y,x)
      Theta_M = Pi + ASIN((1024.0 * Pi**2 * COS(Pi * GaussXc) * 
     &  SIN(Pi * GaussXc)**3) / (45.0 * (150.0 + 3.0 * Pi - 
     &  4.0 * Pi * COS(2.0 * Pi * GaussXc) 
     &  + Pi * COS(4.0 * Pi * GaussXc)))) - 
     &  ATAN2(COS((1.0 / 12.0) * (12.0 * Pi * GaussXc - 
     &  8.0 * SIN(2.0 * Pi * GaussXc) + SIN(4.0 * Pi * GaussXc))), 
     &  -SIN((1.0 / 12.0) * (12.0 * Pi * GaussXc - 
     &  8.0 * SIN(2.0 * Pi * GaussXc) + SIN(4.0 * Pi * GaussXc))))
