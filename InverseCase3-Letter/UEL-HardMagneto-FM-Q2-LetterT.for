...
!     swap (x,y) in Mathematica ArcTan[x,y] to align with FORTRAN ATan2(y,x)
      Theta_M = Pi - ASIN((2048.0 * Pi * ((1.0 / COSH(16.0 * 
     &  (GaussXc - 0.6)))**2 * TANH(16.0 * (GaussXc - 0.6)) - 
     &  2.0 * (1.0 / COSH(16.0 * (GaussXc - 0.4)))**2 * 
     &  TANH(16.0 * (GaussXc - 0.4)))) / (81.0 * (4.0 * Pi * 
     &  (1.0 / COSH(16.0 * (GaussXc - 0.6)))**2 - 
     &  8.0 * Pi * (1.0 / COSH(16.0 * (GaussXc - 0.4)))**2 + 
     &  45.0 * (TANH(6.4) + TANH(9.6))))) - 
     &  ATAN2(SIN((Pi * (3.0 * TANH(6.4) - 2.0 * TANH(6.4 - 
     &  16.0 * GaussXc) + TANH(9.6 - 16.0 * GaussXc))) / 
     &  (2.0 * (TANH(6.4) + TANH(9.6)))), 
     &  -COS((Pi * (3.0 * TANH(6.4) - 2.0 * TANH(6.4 - 
     &  16.0 * GaussXc) + TANH(9.6 - 16.0 * GaussXc))) / 
     &  (2.0 * (TANH(6.4) + TANH(9.6)))))
