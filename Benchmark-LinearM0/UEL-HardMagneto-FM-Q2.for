...
C     -- Material Properties --
      ...
      DOUBLE PRECISION :: Gm, Kappa, Mu0, Epsilon, Pi, Para_a, Para_b
...
C     PROPS(9) - Para_a: Parameter a, constant
C     PROPS(10) - Para_b: Parameter b, slope
...
!     swap (x,y) in Mathematica ArcTan[x,y] to align with FORTRAN ATan2(y,x)
      Theta_M = Pi - ASIN((16.0 * h**2 * Pi) / 
     &  (3.0 * SQRT(Epsilon**2 * (1.0 + (Para_b**2 * h**2) / 
     &  (Para_a + Para_b * GaussXc)**2 - 
     &  (2.0 * Para_b * h * SIN(2.0 * (Pi * (-2.0 + GaussXc) * 
     &  GaussXc + Theta_b))) / (Para_a + Para_b * GaussXc) + 
     &  (4.0 * h * Pi * (-1.0 + GaussXc) * ((-1.0 + h * Pi * 
     &  (-1.0 + GaussXc)) * (Para_a + Para_b * GaussXc) + 
     &  Para_b * h * SIN(2.0 * (Pi * (-2.0 + GaussXc) * GaussXc + 
     &  Theta_b)))) / (Para_a + Para_b * GaussXc))))) - 
     &  ATAN2(Epsilon * (-((Para_b * h * COS(Pi * (-2.0 + GaussXc) * 
     &  GaussXc + Theta_b)) / (Para_a + Para_b * GaussXc)) + 
     &  (1.0 - 2.0 * h * Pi * (-1.0 + GaussXc)) * 
     &  SIN(Pi * (-2.0 + GaussXc) * GaussXc + Theta_b)), 
     &  Epsilon * ((-1.0 + 2.0 * h * Pi * (-1.0 + GaussXc)) * 
     &  COS(Pi * (-2.0 + GaussXc) * GaussXc + Theta_b) + 
     &  (Para_b * h * SIN(Pi * (-2.0 + GaussXc) * GaussXc + 
     &  Theta_b)) / (Para_a + Para_b * GaussXc)))
