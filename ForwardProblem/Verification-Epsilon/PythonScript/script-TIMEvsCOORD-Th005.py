...
odb_path = 'T:/Abaqus-Temp/20260110MagnetoBeam/Verification-Epsilon/'

# Define the file path for the output
folder_name = os.path.join(odb_path, 'Output/')
if not os.path.exists(folder_name):
    os.makedirs(folder_name)
process_odb_file('Beam-Th005-Epsilon-Case1-1.odb', 'Beam-Th005-Epsilon-Case1-1.csv')
process_odb_file('Beam-Th005-Epsilon-Case1-2.odb', 'Beam-Th005-Epsilon-Case1-2.csv')
process_odb_file('Beam-Th005-Epsilon-Case1-3.odb', 'Beam-Th005-Epsilon-Case1-3.csv')
process_odb_file('Beam-Th005-Epsilon-Case1-4.odb', 'Beam-Th005-Epsilon-Case1-4.csv')
process_odb_file('Beam-Th005-Epsilon-Case1-5.odb', 'Beam-Th005-Epsilon-Case1-5.csv')

process_odb_file('Beam-Th005-Epsilon-Case2-1.odb', 'Beam-Th005-Epsilon-Case2-1.csv')
process_odb_file('Beam-Th005-Epsilon-Case2-2.odb', 'Beam-Th005-Epsilon-Case2-2.csv')
process_odb_file('Beam-Th005-Epsilon-Case2-3.odb', 'Beam-Th005-Epsilon-Case2-3.csv')
process_odb_file('Beam-Th005-Epsilon-Case2-4.odb', 'Beam-Th005-Epsilon-Case2-4.csv')
process_odb_file('Beam-Th005-Epsilon-Case2-5.odb', 'Beam-Th005-Epsilon-Case2-5.csv')

process_odb_file('Beam-Th005-Epsilon-Case3-1.odb', 'Beam-Th005-Epsilon-Case3-1.csv')
process_odb_file('Beam-Th005-Epsilon-Case3-2.odb', 'Beam-Th005-Epsilon-Case3-2.csv')
process_odb_file('Beam-Th005-Epsilon-Case3-3.odb', 'Beam-Th005-Epsilon-Case3-3.csv')
process_odb_file('Beam-Th005-Epsilon-Case3-4.odb', 'Beam-Th005-Epsilon-Case3-4.csv')
process_odb_file('Beam-Th005-Epsilon-Case3-5.odb', 'Beam-Th005-Epsilon-Case3-5.csv')